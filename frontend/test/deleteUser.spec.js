...
describe("Delete user test", function() {
    ...
    it("delete user successfully", async function() {
        ...
        const registerButton = await driver.wait(until.elementLocated(By.className('btn')), 5000);
        ...
        await alert.accept();
        assert.strictEqual(msg, 'User deleted successfully!', 'Expected message does not match actual message');
    });
});
